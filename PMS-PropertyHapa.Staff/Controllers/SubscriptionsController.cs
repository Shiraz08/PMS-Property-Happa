...
namespace PMS_PropertyHapa.Staff.Controllers
{
    public class SubscriptionsController : Controller
    {
        ...
        public SubscriptionsController(IAuthService authService, IConfiguration configuration, IStripeService stripeService, EmailSenderBase emailSenderBase, IWebHostEnvironment environment = null)
        {
        ...
        public async Task<IActionResult> CreateSubscription([FromBody] SubscriptionRequest request)
        {
                    ...
                    Items = new List<SubscriptionItemOptions>
            {
                ...
                //body = body.Replace("{InvoiceID}", "Inv" + invoiceData.InvoiceId);

                body = body.Replace("{User_Name}", invoiceData.FullName);
                body = body.Replace("{User_Email}", invoiceData.Email);
                body = body.Replace("{User_GYM}", invoiceData.CompanyName);
